...
//
//---------------------------------------------------------------
typedef struct stPACKET_SC_CREATE_MY_CHARACTER stPACKET_SC_CREATE_OTHER_CHARACTER;
...
//
//---------------------------------------------------------------
typedef struct stPACKET_CS_MOVE_START stPACKET_CS_MOVE_STOP;
...
//
//---------------------------------------------------------------
typedef struct stPACKET_SC_MOVE_START stPACKET_SC_MOVE_STOP;
...
//
//---------------------------------------------------------------
typedef struct stPACKET_SC_MOVE_START stPACKET_SC_ATTACK1;
...
//
//---------------------------------------------------------------
typedef struct stPACKET_CS_ATTACK1 stPACKET_CS_ATTACK2;
...
//
//---------------------------------------------------------------
typedef struct stPACKET_SC_MOVE_START stPACKET_SC_ATTACK2;
...
//
//---------------------------------------------------------------
typedef struct stPACKET_CS_ATTACK1 stPACKET_CS_ATTACK3;
...
//
//---------------------------------------------------------------
typedef struct stPACKET_SC_MOVE_START stPACKET_SC_ATTACK3;
...
struct stPacket_ArgCollectionBox
{
	INT		PacketType;
	DWORD	ID;
	BYTE		Direction;
